                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <table class="table table-bordered table-hover" id="invoiceItem">
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="productCode[]" id="productCode_1" class="form-control" autocomplete="off" value="1" readonly></td>
                            <!--<td><input type="text" name="productName[]" id="productName_1" class="form-control" autocomplete="off"></td>-->
                            <td><select name="productName[]" id="productName_1" class="form-control">
                                    <?php
                                foreach (dataApi() as $consumo) {
                                    echo '<option value=' . $consumo['id'] . '>' . $consumo['proname'] . '</option>';
                                }
                                ?>
                                </select></td>
                            ...
                            <td><input type="number" name="price[]" id="price_1" class="form-control price"
                                    autocomplete="off" value='<?php echo $price; ?>'></td>
                ...
                <div class="modal-body">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                                ...
                                foreach (dataApi() as $consumo) {
                                    echo '<tr>';
                                    echo '<td><button class="btn btn-success" id="addRows" type="button">Seleccionar</button></td>';
                                    //echo '<option value=' . $consumo['id'] . '>' . $consumo['proname'] . '</option>';
                                    echo '<td>'. $consumo['proname'] .'</td>';
                                    echo '<td>'. $consumo['amount'] .'</td>';
                                    echo '</tr>';
                                }
                                ?>
                        </tbody>
